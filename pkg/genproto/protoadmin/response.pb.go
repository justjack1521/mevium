...
var file_protoadmin_response_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x64, 0x22, 0x20, 0x0a, 0x1e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x75,
	0x67, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x73, 0x52, 0x65,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x61, 0x64, 0x6d, 0x69, 0x6e,
...
var file_protoadmin_response_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func file_protoadmin_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protoadmin_response_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateAugmentMaterialsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
