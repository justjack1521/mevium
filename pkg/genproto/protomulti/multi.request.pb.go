...
const (
	...
	MultiRequestType_INSPECT_LOBBY  MultiRequestType = 700
...
type InspectLobbyRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InspectLobbyRequest) Reset() {
	*x = InspectLobbyRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *InspectLobbyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InspectLobbyRequest) ProtoMessage() {}

func (x *InspectLobbyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protomulti_multi_request_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InspectLobbyRequest.ProtoReflect.Descriptor instead.
func (*InspectLobbyRequest) Descriptor() ([]byte, []int) {
	return file_protomulti_multi_request_proto_rawDescGZIP(), []int{3}
}

func (x *InspectLobbyRequest) GetPlayerId() string {
	if x != nil {
		return x.PlayerId
	}
	return ""
...
func (x *InspectLobbyRequest) GetLobbyId() string {
	if x != nil {
		return x.LobbyId
	}
	return ""
...
var file_protomulti_multi_request_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x70, 0x61, 0x72, 0x74, 0x79, 0x49, 0x64, 0x22, 0x4d, 0x0a, 0x13, 0x49, 0x6e,
	0x73, 0x70, 0x65, 0x63, 0x74, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x64, 0x12, 0x19,
	0x0a, 0x08, 0x6c, 0x6f, 0x62, 0x62, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x6c, 0x6f, 0x62, 0x62, 0x79, 0x49, 0x64, 0x22, 0x4d, 0x0a, 0x13, 0x44, 0x69, 0x73,
	...
	0x07, 0x6c, 0x6f, 0x62, 0x62, 0x79, 0x49, 0x64, 0x22, 0x88, 0x01, 0x0a, 0x10, 0x4a, 0x6f, 0x69,
	...
	0xb3, 0x01, 0x0a, 0x10, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x45, 0x41, 0x44, 0x59, 0x5f, 0x4c, 0x4f, 0x42, 0x42, 0x59, 0x10, 0xd8, 0x04, 0x12, 0x12, 0x0a,
	0x0d, 0x49, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x54, 0x5f, 0x4c, 0x4f, 0x42, 0x42, 0x59, 0x10, 0xbc,
	0x05, 0x12, 0x12, 0x0a, 0x0d, 0x44, 0x49, 0x53, 0x43, 0x41, 0x52, 0x44, 0x5f, 0x4c, 0x4f, 0x42,
	0x42, 0x59, 0x10, 0xa0, 0x06, 0x42, 0x4d, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_protomulti_multi_request_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_protomulti_multi_request_proto_goTypes = []interface{}{
	...
	(*InspectLobbyRequest)(nil),  // 4: multi.InspectLobbyRequest
	(*DiscardLobbyRequest)(nil),  // 5: multi.DiscardLobbyRequest
	(*JoinLobbyRequest)(nil),     // 6: multi.JoinLobbyRequest
	(*ReadyLobbyRequest)(nil),    // 7: multi.ReadyLobbyRequest
}
...
func file_protomulti_multi_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protomulti_multi_request_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InspectLobbyRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
