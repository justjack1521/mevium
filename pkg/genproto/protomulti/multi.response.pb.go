...
type GetLobbyPlayerResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Player     *ProtoLobbyPlayer `protobuf:"bytes,1,opt,name=player,proto3" json:"player,omitempty"`
...
func (x *GetLobbyPlayerResponse) Reset() {
	*x = GetLobbyPlayerResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLobbyPlayerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLobbyPlayerResponse) ProtoMessage() {}

func (x *GetLobbyPlayerResponse) ProtoReflect() protoreflect.Message {
	mi := &file_protomulti_multi_response_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLobbyPlayerResponse.ProtoReflect.Descriptor instead.
func (*GetLobbyPlayerResponse) Descriptor() ([]byte, []int) {
	return file_protomulti_multi_response_proto_rawDescGZIP(), []int{10}
}

func (x *GetLobbyPlayerResponse) GetPlayer() *ProtoLobbyPlayer {
	if x != nil {
		return x.Player
	}
	return nil
...
func (x *GetLobbyPlayerResponse) GetLobbyId() string {
	if x != nil {
		return x.LobbyId
	}
	return ""
...
func (x *GetLobbyPlayerResponse) GetPlayerSlot() int32 {
	if x != nil {
		return x.PlayerSlot
	}
	return 0
...
var file_protomulti_multi_response_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x72, 0x53, 0x6c, 0x6f, 0x74, 0x42, 0x4d, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
func file_protomulti_multi_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protomulti_multi_response_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLobbyPlayerResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
