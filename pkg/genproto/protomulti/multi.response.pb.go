...
type InspectLobbyResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *InspectLobbyResponse) Reset() {
	*x = InspectLobbyResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *InspectLobbyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InspectLobbyResponse) ProtoMessage() {}

func (x *InspectLobbyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_protomulti_multi_response_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InspectLobbyResponse.ProtoReflect.Descriptor instead.
func (*InspectLobbyResponse) Descriptor() ([]byte, []int) {
...
var file_protomulti_multi_response_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x07, 0x6c, 0x6f, 0x62, 0x62, 0x69, 0x65, 0x73, 0x22, 0x16, 0x0a, 0x14, 0x49, 0x6e,
	0x73, 0x70, 0x65, 0x63, 0x74, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x16, 0x0a, 0x14, 0x44, 0x69, 0x73, 0x63, 0x61, 0x72, 0x64, 0x4c, 0x6f, 0x62,
	0x62, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x13, 0x0a, 0x11, 0x4a, 0x6f,
	0x69, 0x6e, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x14, 0x0a, 0x12, 0x52, 0x65, 0x61, 0x64, 0x79, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x4d, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_protomulti_multi_response_proto_goTypes = []interface{}{
	...
	(*InspectLobbyResponse)(nil),  // 3: multi.InspectLobbyResponse
...
func file_protomulti_multi_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protomulti_multi_response_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InspectLobbyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
