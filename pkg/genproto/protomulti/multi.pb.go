...
type ProtoGamePlayer struct {
	...
	Identity *protoidentity.ProtoPlayerIdentity `protobuf:"bytes,1,opt,name=identity,proto3" json:"identity,omitempty"`
	Loadout  *protoidentity.ProtoPlayerLoadout  `protobuf:"bytes,2,opt,name=loadout,proto3" json:"loadout,omitempty"`
}
...
func (x *ProtoGamePlayer) GetIdentity() *protoidentity.ProtoPlayerIdentity {
	if x != nil {
		return x.Identity
	}
	return nil
...
var file_protomulti_multi_proto_rawDesc = []byte{
	...
	0x41, 0x74, 0x22, 0x84, 0x01, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x47, 0x61, 0x6d, 0x65,
	0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x39, 0x0a, 0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69,
	...
	0x79, 0x12, 0x36, 0x0a, 0x07, 0x6c, 0x6f, 0x61, 0x64, 0x6f, 0x75, 0x74, 0x18, 0x02, 0x20, 0x01,
	...
	0x52, 0x07, 0x6c, 0x6f, 0x61, 0x64, 0x6f, 0x75, 0x74, 0x42, 0x4d, 0x5a, 0x36, 0x67, 0x69, 0x74,
...
var file_protomulti_multi_proto_goTypes = []interface{}{
	...
	(*ProtoGamePlayer)(nil),                          // 5: multi.ProtoGamePlayer
...
var file_protomulti_multi_proto_depIdxs = []int32{
	...
	6, // 4: multi.ProtoGamePlayer.identity:type_name -> identity.ProtoPlayerIdentity
	8, // 5: multi.ProtoGamePlayer.loadout:type_name -> identity.ProtoPlayerLoadout
