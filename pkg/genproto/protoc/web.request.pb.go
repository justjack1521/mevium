...
var file_web_request_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_web_request_proto_goTypes = []interface{}{
	...
	(*BaseRequest)(nil),          // 1: protoc.BaseRequest
	(*CreateProfileRequest)(nil), // 2: protoc.CreateProfileRequest
}
var file_web_request_proto_depIdxs = []int32{
	0, // 0: protoc.BaseRequest.header:type_name -> protoc.RequestHeader
