...
func (c *meviusAdminServiceClient) CreateAbilityCard(ctx context.Context, in *protoadmin.CreateAbilityCardRequest, opts ...grpc.CallOption) (*protoadmin.CreateAbilityCardResponse, error) {
	out := new(protoadmin.CreateAbilityCardResponse)
	err := c.cc.Invoke(ctx, MeviusAdminService_CreateAbilityCard_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *meviusAdminServiceClient) CreateAbility(ctx context.Context, in *protoadmin.CreateAbilityRequest, opts ...grpc.CallOption) (*protoadmin.CreateAbilityResponse, error) {
	out := new(protoadmin.CreateAbilityResponse)
	err := c.cc.Invoke(ctx, MeviusAdminService_CreateAbility_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MeviusAdminService_CreateAbilityCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(protoadmin.CreateAbilityCardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MeviusAdminServiceServer).CreateAbilityCard(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MeviusAdminService_CreateAbilityCard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeviusAdminServiceServer).CreateAbilityCard(ctx, req.(*protoadmin.CreateAbilityCardRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MeviusAdminService_CreateAbility_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(protoadmin.CreateAbilityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MeviusAdminServiceServer).CreateAbility(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MeviusAdminService_CreateAbility_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeviusAdminServiceServer).CreateAbility(ctx, req.(*protoadmin.CreateAbilityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
