...
var file_access_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x72, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x32, 0xc0, 0x02, 0x0a, 0x0d,
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x36,
...
var file_access_proto_goTypes = []interface{}{
	...
	(*common.RequestHeader)(nil),   // 8: protoc.RequestHeader
	(*common.ResponseHeader)(nil),  // 9: protoc.ResponseHeader
}
var file_access_proto_depIdxs = []int32{
	8,  // 0: protoc.ChangePasswordRequest.header:type_name -> protoc.RequestHeader
	9,  // 1: protoc.ChangePasswordResponse.header:type_name -> protoc.ResponseHeader
	8,  // 2: protoc.LoginUserRequest.header:type_name -> protoc.RequestHeader
	9,  // 3: protoc.LoginUserResponse.header:type_name -> protoc.ResponseHeader
	8,  // 4: protoc.RefreshTokenRequest.header:type_name -> protoc.RequestHeader
	9,  // 5: protoc.RefreshTokenResponse.header:type_name -> protoc.ResponseHeader
	8,  // 6: protoc.RegisterUserRequest.header:type_name -> protoc.RequestHeader
	9,  // 7: protoc.RegisterUserResponse.header:type_name -> protoc.ResponseHeader
	0,  // 8: protoc.AccessService.ChangePassword:input_type -> protoc.ChangePasswordRequest
	2,  // 9: protoc.AccessService.LoginUser:input_type -> protoc.LoginUserRequest
	4,  // 10: protoc.AccessService.RefreshToken:input_type -> protoc.RefreshTokenRequest
	6,  // 11: protoc.AccessService.RegisterUser:input_type -> protoc.RegisterUserRequest
	1,  // 12: protoc.AccessService.ChangePassword:output_type -> protoc.ChangePasswordResponse
	3,  // 13: protoc.AccessService.LoginUser:output_type -> protoc.LoginUserResponse
	5,  // 14: protoc.AccessService.RefreshToken:output_type -> protoc.RefreshTokenResponse
	7,  // 15: protoc.AccessService.RegisterUser:output_type -> protoc.RegisterUserResponse
