...
type ProtocChangePasswordResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ProtocChangePasswordResponse) Reset() {
	*x = ProtocChangePasswordResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProtocChangePasswordResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtocChangePasswordResponse) ProtoMessage() {}

func (x *ProtocChangePasswordResponse) ProtoReflect() protoreflect.Message {
	mi := &file_access_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtocChangePasswordResponse.ProtoReflect.Descriptor instead.
func (*ProtocChangePasswordResponse) Descriptor() ([]byte, []int) {
	return file_access_proto_rawDescGZIP(), []int{1}
}

func (x *ProtocChangePasswordResponse) GetHeader() *common.ResponseHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
var file_access_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x22, 0x4e, 0x0a, 0x1c, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x43, 0x68, 0x61,
	...
	0x64, 0x65, 0x72, 0x22, 0x79, 0x0a, 0x10, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2d, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63,
	0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x06,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61,
	...
	0x61, 0x64, 0x65, 0x72, 0x12, 0x21, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x74,
	...
	0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x36, 0x5a, 0x34,
...
var file_access_proto_goTypes = []interface{}{
	...
	(*ProtocChangePasswordResponse)(nil), // 1: protoc.protocChangePasswordResponse
...
var file_access_proto_depIdxs = []int32{
	...
	5, // 1: protoc.protocChangePasswordResponse.header:type_name -> protoc.ResponseHeader
...
func file_access_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_access_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtocChangePasswordResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
