...
type MeviusSocialServiceClient interface {
	...
	GetPlayerIdentity(ctx context.Context, in *protop.GetPlayerIdentityRequest, opts ...grpc.CallOption) (*protop.GetPlayerIdentityResponse, error)
}
...
func (c *meviusSocialServiceClient) GetPlayerIdentity(ctx context.Context, in *protop.GetPlayerIdentityRequest, opts ...grpc.CallOption) (*protop.GetPlayerIdentityResponse, error) {
	out := new(protop.GetPlayerIdentityResponse)
...
type MeviusSocialServiceServer interface {
	...
	GetPlayerIdentity(context.Context, *protop.GetPlayerIdentityRequest) (*protop.GetPlayerIdentityResponse, error)
}
...
func (UnimplementedMeviusSocialServiceServer) GetPlayerIdentity(context.Context, *protop.GetPlayerIdentityRequest) (*protop.GetPlayerIdentityResponse, error) {
...
func _MeviusSocialService_GetPlayerIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(protop.GetPlayerIdentityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeviusSocialServiceServer).GetPlayerIdentity(ctx, req.(*protop.GetPlayerIdentityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
