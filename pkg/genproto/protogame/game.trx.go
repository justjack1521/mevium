...
func NewClaimRegionMapRequest(bytes []byte) (*ClaimRegionMapRequest, error) {
	req := &ClaimRegionMapRequest{}
	if err := proto.Unmarshal(bytes, req); err != nil {
		return nil, err
	}
	return req, nil
...
func NewArenaStartRequest(bytes []byte) (*ArenaStartRequest, error) {
...
func NewConfirmGiftBoxRequest(bytes []byte) (*ConfirmGiftBoxRequest, error) {
	req := &ConfirmGiftBoxRequest{}
	if err := proto.Unmarshal(bytes, req); err != nil {
		return nil, err
	}
	return req, nil
...
func (x *ClaimRegionMapResponse) MarshallBinary() ([]byte, error) {
	return proto.Marshal(x)
}
