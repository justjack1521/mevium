...
func (x *GetPlayerChallengeResponse) Reset() {
	*x = GetPlayerChallengeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_challenge_response_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetPlayerChallengeResponse) Descriptor() ([]byte, []int) {
	return file_challenge_response_proto_rawDescGZIP(), []int{2}
}
...
var file_challenge_response_proto_rawDesc = []byte{
	...
	0x22, 0x63, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x43, 0x68, 0x61,
	0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x45,
	...
	0x67, 0x65, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x09, 0x63, 0x68, 0x61, 0x6c,
	0x6c, 0x65, 0x6e, 0x67, 0x65, 0x42, 0x44, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x63, 0xaa, 0x02, 0x0c, 0x4d,
...
var file_challenge_response_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
func file_challenge_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_challenge_response_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
