...
type WeeklyRankRangeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *WeeklyRankRangeRequest) Reset() {
	*x = WeeklyRankRangeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *WeeklyRankRangeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WeeklyRankRangeRequest) ProtoMessage() {}

func (x *WeeklyRankRangeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rank_request_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WeeklyRankRangeRequest.ProtoReflect.Descriptor instead.
func (*WeeklyRankRangeRequest) Descriptor() ([]byte, []int) {
	return file_rank_request_proto_rawDescGZIP(), []int{1}
}

func (x *WeeklyRankRangeRequest) GetPlayerId() string {
	if x != nil {
		return x.PlayerId
	}
	return ""
...
func (x *WeeklyRankRangeRequest) GetRegionId() string {
	if x != nil {
		return x.RegionId
	}
	return ""
...
type SpecialRankRangeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SpecialRankRangeRequest) Reset() {
	*x = SpecialRankRangeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SpecialRankRangeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpecialRankRangeRequest) ProtoMessage() {}

func (x *SpecialRankRangeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rank_request_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpecialRankRangeRequest.ProtoReflect.Descriptor instead.
func (*SpecialRankRangeRequest) Descriptor() ([]byte, []int) {
	return file_rank_request_proto_rawDescGZIP(), []int{2}
}

func (x *SpecialRankRangeRequest) GetPlayerId() string {
	if x != nil {
		return x.PlayerId
	}
	return ""
...
func (x *SpecialRankRangeRequest) GetRegionId() string {
	if x != nil {
		return x.RegionId
	}
	return ""
...
var file_rank_request_proto_rawDesc = []byte{
	...
	0x6f, 0x61, 0x64, 0x6f, 0x75, 0x74, 0x22, 0x52, 0x0a, 0x16, 0x57, 0x65, 0x65, 0x6b, 0x6c, 0x79,
	...
	0x52, 0x08, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x53, 0x0a, 0x17, 0x53, 0x70,
	0x65, 0x63, 0x69, 0x61, 0x6c, 0x52, 0x61, 0x6e, 0x6b, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x65,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x42,
...
var file_rank_request_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_rank_request_proto_goTypes = []interface{}{
	(*SubmitScoreRequest)(nil),        // 0: rank.SubmitScoreRequest
	(*WeeklyRankRangeRequest)(nil),    // 1: rank.WeeklyRankRangeRequest
	(*SpecialRankRangeRequest)(nil),   // 2: rank.SpecialRankRangeRequest
	(*protog.ProtoPlayerLoadout)(nil), // 3: protog.ProtoPlayerLoadout
}
var file_rank_request_proto_depIdxs = []int32{
	3, // 0: rank.SubmitScoreRequest.loadout:type_name -> protog.ProtoPlayerLoadout
...
func file_rank_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rank_request_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WeeklyRankRangeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rank_request_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SpecialRankRangeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
